        ...
        <div className="max-w-5xl mx-auto px-6 space-y-14">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 border border-trustnet-bg-light space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              Once an article is submitted to the conference, the authors agree
              to our review policy.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 border border-trustnet-bg-light space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              Authors submitting manuscripts acknowledge that their work has not
          ...
          <div className="text-gray-700 leading-relaxed text-justify space-y-4">
            ...
            <p>
              If the paper is accepted, at least one of the authors must
          ...
          <div className="text-gray-700 leading-relaxed text-justify space-y-4">
            ...
            <p>
              Select accepted and presented papers will be submitted for
              publication.
            </p>
          </div>
          ...
          <div className="text-gray-700 leading-relaxed text-justify space-y-4">
            ...
            <p>
              Articles cannot be publicised until official acceptance.
            </p>
          </div>
